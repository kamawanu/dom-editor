...
menu = Menu('main', [
		('/File', None, '<Branch>', ''),
		('/File/Save', 'menu_save', '<StockItem>', '<Ctrl>S', g.STOCK_SAVE),
		('/File/Blank document', 'do_blank_all', '<StockItem>', '<Ctrl>N', g.STOCK_NEW),
		('/File/Clear undo buffer', 'menu_clear_undo', '<StockItem>', '', g.STOCK_CLEAR),

		('/Edit', None, '<Branch>', ''),
		('/Edit/Copy attributes', 'do_yank_attributes', '<StockItem>', '', g.STOCK_COPY),
		('/Edit/Paste attributes', 'do_paste_attribs', '<StockItem>', '', g.STOCK_PASTE),
		('/Edit/Copy attrib value', 'do_yank_value', '<StockItem>', '', g.STOCK_COPY),
		('/Edit/Rename attribute', 'menu_rename_attr', '<StockItem>', '', g.STOCK_PROPERTIES),
		('/Edit/', '', '', '<separator>'),
		('/Edit/Cut', 'do_delete_node', '<StockItem>', '<Ctrl>X', g.STOCK_DELETE),
		('/Edit/Delete', 'do_delete_node_no_clipboard', '<StockItem>', '', g.STOCK_DELETE),
		('/Edit/Shallow cut', 'do_delete_shallow', '<StockItem>', '<Shift>X', g.STOCK_DELETE),
		('/Edit/', '', '', '<separator>'),
		('/Edit/Copy', 'do_yank', '<StockItem>', '<Ctrl>C', g.STOCK_COPY),
		('/Edit/Shallow copy', 'do_shallow_yank', '<StockItem>', '<Shift>Y', g.STOCK_COPY),
		('/Edit/', '', '', '<separator>'),
		('/Edit/Paste (replace)','do_put_replace', '<StockItem>', '<Ctrl>V', g.STOCK_PASTE),
		('/Edit/Paste (inside)', 'do_put_as_child', '<StockItem>', 'bracketright', g.STOCK_GO_FORWARD),
		('/Edit/Paste (before)', 'do_put_before', '<StockItem>', '<Shift>P', g.STOCK_GO_UP),
		('/Edit/Paste (after)', 'do_put_after', '<StockItem>', 'p', g.STOCK_GO_DOWN),
		('/Edit/', '', '', '<separator>'),
		('/Edit/Edit value', 'toggle_edit', '<StockItem>', 'Return', g.STOCK_PROPERTIES),
		('/Edit/', '', '', '<separator>'),
		('/Edit/Undo', 'do_undo', '<StockItem>', '<Ctrl>Z', g.STOCK_UNDO),
		('/Edit/Redo', 'do_redo', '<StockItem>', '<Ctrl>Y', g.STOCK_REDO),

		('/Move', None, '<Branch>', ''),
		('/Move/XPath search', 'menu_show_search', '<StockItem>', 'slash', g.STOCK_FIND),
		('/Move/Text search', 'menu_show_text_search', '<StockItem>', 'T', g.STOCK_FIND),
		('/Move/Enter', 'do_enter', '', '<Shift>greater'),
		('/Move/Leave', 'do_leave', '', '<Shift>less'),
		
		('/Move/Root node', 'move_home', '<StockItem>', 'Home', g.STOCK_HOME),
		('/Move/Previous sibling', 'move_prev_sib', '<StockItem>', 'Up', g.STOCK_GO_UP),
		('/Move/Next sibling', 'move_next_sib', '<StockItem>', 'Down', g.STOCK_GO_DOWN),
		('/Move/Parent', 'move_left', '<StockItem>', 'Left', g.STOCK_GO_BACK),
		('/Move/First child', 'move_right', '<StockItem>', 'Right', g.STOCK_GO_FORWARD),
		('/Move/Last child', 'move_end', '<StockItem>', 'End', g.STOCK_GOTO_LAST),
		...
		('/Create', None, '<Branch>', ''),
		('/Create/Insert node', 'menu_insert_element', '<StockItem>', 'I', g.STOCK_ADD),
		('/Create/Append node', 'menu_append_element', '<StockItem>', 'A', g.STOCK_ADD),
		('/Create/Open node inside', 'menu_open_element', '<StockItem>', 'O', g.STOCK_ADD),
